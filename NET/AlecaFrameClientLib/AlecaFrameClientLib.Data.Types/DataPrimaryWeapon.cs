...
public class DataPrimaryWeapon : BigItem
{
	...
	public override bool IsOwned()
	{
		...
		if (StaticData.dataHandler.warframeRootObject.LongGuns.Any((Longgun p) => p.ItemType == base.uniqueName))
		{
			return true;
		}
		return false;
	...
	{
		if (base.uniqueName == "/Lotus/Weapons/Operator/Pistols/DrifterPistol/DrifterPistolPlayerWeapon")
		{
			return false;
		}
		return true;
